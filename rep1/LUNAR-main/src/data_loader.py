...
def LLAMA31_BASE_TEMPLATE(instruction):
...
def convert_raw_data_to_model_qa(tokenizer, max_length, question, answer, configs):
    ...
    elif configs.model_family in {"llama31-8b-base", "llama-3.1-8b-base", "llama31-base"}:
        new_question = LLAMA31_BASE_TEMPLATE(question)
