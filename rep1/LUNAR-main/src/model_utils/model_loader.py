...
from src.model_utils.llama31_base_model import Llama31BaseModel
...
def load_model(model_family, model_path, device):
    ...
    elif model_family in {"llama31-8b-base", "llama-3.1-8b-base", "llama31-base"}:
        model_base = Llama31BaseModel(model_path)
